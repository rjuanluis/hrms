...
1. PR and immutable production image are audited at the exact SHA; the isolated MariaDB authority-lock job proves that both a second-vacancy insert and a status transition wait until the intake transaction releases its lock.
